...
<html lang="en">
  ...
  <body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-3 col-md-4 col-sm-6">
				<a  class=" img-responsive thumbnail" >
					<p><span class="h4">Robovie</span>  -  price: $55</p>
		...
		<div class="row">
			<p>  
				Servo motor: VS-S092J × 17 pieces </br>
				Interface: (corresponding to Windows2000 / XP / Vista) USB </br>
				Audio output featured, dedicated software original motion can be created by "RobovieMaker2"  </br>

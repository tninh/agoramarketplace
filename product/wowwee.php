...
<html lang="en">
  ...
  <body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-3 col-md-4 col-sm-6">
				<a class=" img-responsive thumbnail" >
					<p><span class="h4">Wowwee</span>  -  price: $55</p>
		...
		<div class="row">
			<p>  
			 GestureSense allows your WowWee robot to respond to gesture-based interactions like swipes, claps, touch and more. </br>
			BLE allows your WowWee product to seamlessly connect to and interact with your smart devices. </br>
			Sound detection system allows your WowWee robot to react to noises in its environment. </br>
			Free app provides control and/or enhanced gameplay on your smart device.  </br>

...
<html lang="en">
  ...
  <body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-3 col-md-4 col-sm-6">
				<a class=" img-responsive thumbnail" >
					<p><span class="h4">Smart Robot</span>  -  price: $59</p>
		...
		<div class="row">
			<p>  
			 Top Race® Remote Control Robot, Smart Self Balancing Robot, </br>
			5 Real Lifelike Operating Modes, Dancing, Boxing, Driving, Loading, Gesture.  </br>
			Equipped with a Strong 2.4Ghz Transmitter controllable Distance more the 65 Feet  </br>
			Responsive Personality Communicated through Motion, Sounds, and RGB LED Lights  </br>
			9 Inches Tall, Robot Uses 4x "AAA" batteries (Included) Controller Uses 2x "AAA"   </br>

...
<div class = "col-md-6 col-md-offset-3">
  <form method="post" action="searchuser.php">
	<p><select name="searchuserby" id="searchuserby">
		<option value="0" name="0" selected="selected">Search User By</option>
		<option value="byUserName" >Search by Name</option>
		<option value="byUserEmail" >Search by Email</option>
		<option value="byUserPhone" >Search by Phone</option>
	</select></p>
	
   <div class="input-group">
      <input type="text" class="form-control" placeholder="Search" name="searchText" />
      
	  <div class="input-group-btn"> <button class="btn btn-default" type="submit"> <span class="glyphicon glyphicon-search"></span>Search</button> </div> 
    </div> <br />
